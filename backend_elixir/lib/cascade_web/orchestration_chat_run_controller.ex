defmodule CascadeWeb.OrchestrationChatRunController do
  @moduledoc "Chat-run orchestration endpoint implementation, preserving dispatch ownership and queue semantics."
  ...
  def create(conn, user, request_vault, params, prompt) do
