...
- Review the use of third-party product names as nominative references. The MIT
  license grants no trademark rights; avoid implying endorsement.
...
- Every contributor whose work remains in the Git history has agreed to the MIT
  license.
- The Fizzer gem, desktop, mobile, favicon, splash, and launcher artwork was
  generated by the project owner and is approved for MIT redistribution.
